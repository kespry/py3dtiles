...
class TestTilesetReader(unittest.TestCase):
    ...
    def test_read(self):
        ...
        self.assertEqual(tile_1_content.header.tile_byte_length, 6148)
        self.assertEqual(tile_1_content.header.ft_json_byte_length, 20)
        ...
        self.assertEqual(len(tile_1_content.body.glTF.to_array()), 6036)

        tile_2_content = tiles[1].get_content()
        self.assertEqual(tile_2_content.header.version, 1.0)
        self.assertEqual(tile_2_content.header.tile_byte_length, 6756)
        self.assertEqual(tile_2_content.header.ft_json_byte_length, 20)
        ...
        self.assertEqual(len(tile_2_content.body.glTF.to_array()), 6612)
...
class TestTexturedTileBuilder(unittest.TestCase):
    ...
    def test_build(self):
        ...
        t.to_array()
        self.assertEqual(t.header.version, 1.0)
        self.assertEqual(t.header.tile_byte_length, 1636)
        self.assertEqual(t.header.ft_json_byte_length, 20)
        self.assertEqual(t.header.ft_bin_byte_length, 0)
        self.assertEqual(t.header.bt_json_byte_length, 0)
        self.assertEqual(t.header.bt_bin_byte_length, 0)
